...
- **S-04: Follow users, view list of followed profiles in Friends tab, view list of followers in Friends tab** — Completed 2026-05-31. Includes follow/unfollow API endpoints, FollowButton component with optimistic updates, Friends page with pagination. Lesson: —.
