...
export const POST: APIRoute = async (context) => {
  ...
  try {
    const body = (await context.request.json()) as RestoreTrickInput;
    ...
    console.error("Unhandled error in POST /api/admin/tricks/restore", err);
